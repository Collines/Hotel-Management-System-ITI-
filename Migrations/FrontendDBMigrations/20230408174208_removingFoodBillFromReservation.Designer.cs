...
namespace HotelManagementSystem.Migrations.FrontendDBMigrations
{
    ...
    [Migration("20230408174208_removingFoodBillFromReservation")]
    partial class removingFoodBillFromReservation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelManagementSystem.City", b =>
                {
            ...
            modelBuilder.Entity("HotelManagementSystem.Guest", b =>
                {
                    b.HasOne("HotelManagementSystem.City", "City")
                        .WithMany()
            ...
            modelBuilder.Entity("HotelManagementSystem.Reservation", b =>
                {
                    b.HasOne("HotelManagementSystem.Guest", "Guest")
                        .WithMany()
                        .HasForeignKey("GuestID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HotelManagementSystem.Room", "Room")
                        .WithMany()
